package com.github.mangelt.lab.util;

public class ApiConstants {
	private ApiConstants() {}
	public static final String API_VERSION = "/v1";
	public static final String MAPPING_AUTHENTICATION = "/authentication";
	public static final String MAPPING_GENERATE = "/generatetoken";
...
//	message for validation
	public static final String USER_SERVICE_USERID_MANDATORY = "User Name is mandatory.";
